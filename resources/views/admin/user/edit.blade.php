                    ...
                    <form action="{{ route('user.update', $dataUser->id) }}"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                {{-- Foto Profil --}}
                                <div class="mb-3">
                                    <label for="avatar" class="form-label fw-
                                        bold">Foto Profil</label>
                                    <div class="card shadow-sm mb-2">
                                        <div class="card-body text-center p-3">
                                            @if ($dataUser->avatar)
                                                <img src="{{ asset('storage/' .
                                                    $dataUser->avatar) }}" alt="Foto User"
                                                ...
                                                <p class="small text-muted mb-
                                                    0">Foto saat ini</p>
                                            @else
                                                <div class="bg-light rounded d-
                                                    flex align-items-center justify-content-center mb-2"
                                                    style="height: 150px;">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="{{ route('user.index') }}" class="btn btn-
                                outline-secondary ms-2">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
